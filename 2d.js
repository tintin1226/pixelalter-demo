    ...
    <section class="pixel-page">
        ...
        <div class="canvas-panel" id="canvas-panel">
            ...
            <div class="canvas-option">
                ...
                <input type="number" id="canvas-dpi" value="350" min="1">
            </div>

            <button class="apply-canvas-btn">Apply</button>
        </div>

        <div class="sub-panel" id="brush-panel">
            <div class="panel-header">
            ...
            <div class="panel-content">
                <div class="brush-section">
                    ...
                    <div class="brush-grid">
                        <div class="brush-item active">
                            <img src="assets/brush.jpg" alt="Basic Brush">
                            <span>FeltTip Pen</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="brush-section">
                    ...
                    <input type="range" min="0.1" max="1000" value="10">
                    <span class="value">10 px</span>
                </div>

                <div class="brush-section">
                    <label class="row">Opacity <i class="bi bi-eye-fill"></i></label>
  ...
  `;
    ...
    function toggleSharedPanel(panel, button, contentHTML, extraClass = '', toolType = '') {
        button.addEventListener('click', (e) => {
            ...
            // Close all other main panels first
            closeAllMainPanels();
    ...
    toggleSharedPanel(
        ...
        drawBtn,
        `
    <button class="sub-tool" id="brush-tool" title="Brush"><i class="bi bi-brush"></i></button>
    ...
    <button class="sub-tool" title="Ruler"><i class="bi bi-rulers"></i></button>
    <button class="sub-tool" id="color-tool" title="Color" style="color: red;"><i class="bi bi-square-fill"></i></button>
    ...
    <div class="assets-scroll">
        <img src="assets/sample_3.png" alt="Asset 1" class="asset-thumb">
        <img src="assets/sample_5.jpg" alt="Asset 2" class="asset-thumb">
        <img src="assets/sample_9.jpeg" alt="Asset 3" class="asset-thumb">
    </div>
    `,
        'assets-active',
        'assets'
    ...
    animationBtn.addEventListener('click', (e) => {
        ...
        document.getElementById('download-panel').classList.remove('active');
    ...
    drawBtn.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            // Brush tool listener - only works when draw tool is active
            if (brushBtn && !brushBtn.dataset.listenerAttached) {
                brushBtn.dataset.listenerAttached = 'true';
